...
export const SITE = {
  ...
  description:
    "জাচাইডেস্ক — বাংলাদেশের একাধিক পত্রিকা থেকে একই ঘটনার খবর যাচাই করে একটিমাত্র মূল ও প্রমাণসহ সংবাদ হিসেবে প্রকাশ করে। প্রতিটি সংবাদের সাথে সূত্র ও প্রমাণ একসঙ্গে দেখা যায়।",
  url: siteUrl,
  locale: "bn-BD",
  language: "bn",
...
export const authors = [
  {
    slug: "desk",
    name: "জাচাইডেস্ক ডেস্ক",
    shortName: "জাচাইডেস্ক",
    bio: "জাচাইডেস্কের স্বয়ংক্রিয় সংবাদ ডেস্ক — একাধিক পত্রিকা ও দাপ্তরিক সূত্র থেকে সংবাদ যাচাই করে প্রকাশ করা হয়।",
    longBio:
      "জাচাইডেস্ক ডেস্ক স্বয়ংক্রিয় পাইপলাইনের মাধ্যমে ১২টিরও বেশি বাংলাদেশি সংবাদমাধ্যম ও সরকারি-সংস্থার তথ্য সংগ্রহ করে, একই ঘটনার একাধিক প্রতিবেদন মিলিয়ে একটি নির্ভরযোগ্য, প্রমাণসহ সংবাদ তৈরি করে। প্রতিটি সংবাদের প্রতিটি তথ্য সূত্রেব্যবহারে ফিরে দেখা যায়।",
